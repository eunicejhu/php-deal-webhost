            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    ?>
                            <?php if($user): ?>
                            <a class="nav-link"
                                href="https://deal-zuoqin.000webhostapp.com/view/user/view.php?id_user=<?php echo $user["id_membre"] ?>"><?php echo  $user["prenom"] . " " . $user["nom"] ?>
                            </a>
                            <?php endif; ?>
                    ...
                    ?>
                            <?php if($category): ?>
                            <a class="nav-link"
                                href="https://deal-zuoqin.000webhostapp.com/view/category/view.php?id_category=<?php echo $category["id_categorie"] ?>"><?php echo  $category["titre"] ?>
                            </a>
                            <?php endif; ?>
                        </td>
                        ...
                        <td>
                            ...
                            <a href="https://deal-zuoqin.000webhostapp.com/view/post/edit.php?id_post=<?php echo $post["id_annonce"]; ?>"><svg
                            ...
                            <a href="https://deal-zuoqin.000webhostapp.com/view/post/delete.php?id_post=<?php echo $post["id_annonce"]; ?>"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <?php endif; ?>
                            <a href="https://deal-zuoqin.000webhostapp.com/view/post/view.php?id_post=<?php echo $post["id_annonce"]; ?>">
